...
//
//   node scripts/council/status.mjs                 # the newest run in .council/runs/
//   node scripts/council/status.mjs <file.ndjson>   # a specific one
//   node scripts/council/status.mjs --json          # for a program
//
// ── Why this exists ───────────────────────────────────────────────────────────────────────
//
