...
//
//   node scripts/council/feed.mjs                    # follow the newest run
//   node scripts/council/feed.mjs <file.ndjson>      # a specific one
//   node scripts/council/feed.mjs --every=30         # heartbeat cadence in seconds (default 60)
//   node scripts/council/feed.mjs --quiet-after=180  # call it dead after this much silence with no pid
//
