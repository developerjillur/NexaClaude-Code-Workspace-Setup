...
node "$CLAUDE_PLUGIN_ROOT/scripts/council/council.mjs" "Grade this" --context <f>... --rubric # score out of 10
node "$CLAUDE_PLUGIN_ROOT/scripts/council/council.mjs" "<question>" --preflight               # who is here; free

# then, in another terminal — a 20-minute run should not look like a hang
node "$CLAUDE_PLUGIN_ROOT/scripts/council/watch.mjs"
```
