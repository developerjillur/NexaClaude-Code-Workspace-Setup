...
//
//   node scripts/council/watch.mjs                        # follow the newest run in .council/runs/
//   node scripts/council/watch.mjs <file.ndjson>          # follow a specific one
//   node scripts/council/watch.mjs <file.ndjson> --once   # render what is there and exit
//
...
if (!file) {
  process.stderr.write('\n  No event stream to watch.\n\n'
    ...
    + '      node scripts/council/council.mjs "<question>" --context <file> --events\n\n'
